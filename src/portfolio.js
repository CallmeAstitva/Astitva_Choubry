...
const greeting = {
  username: "Astitva Choubey",
  title: "Hi all, I'm Astitva",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1jh_JMpx8XEpR6qXhAPtPXOCnxqHrpu9j/view?usp=drive_link", // Set to empty to hide the button
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "National institute of technology Raipur",
      logo: require("./assets/images/NITR.png"),
      subHeader: "B.Tech",
      duration: "August 2019 - june 2023",
      desc: "Underwent a 4 year program learning basics to deep knowledge in IT feild.",
      descBullets: [
        "8.08 CPI"
      ]
    }
  ...
  experience: [
    {
      ...
      company: "Krayo",
      companylogo: require("./assets/images/krayou.png"),
...
const contactInfo = {
  ...
  number: "+91-9755616654",
  email_address: "astitvachoubey@gmail.com"
};
